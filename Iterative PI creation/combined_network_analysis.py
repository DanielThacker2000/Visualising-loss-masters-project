...
alpha= 0.1
#file_name= "combined_network_data_cv_adjusted.csv"
file_name= "combined_network_data_cv_adjusted.csv"
...
more_plotting.plot_coverage_for_specific_multi(df, strategy1="jackknife_plus", data_name1="linear", noise_type1="normal", layer_size1="(200, 1000)", 
                                               num_samples1=1000, noise_std1=1,cv_size1= 1,x_var="num_samples",
                               strategy2="jackknife_plus", data_name2="linear", noise_type2="normal", layer_size2="(400, 2000, 2000, 2000)", 
                               num_samples2=1000, noise_std2=1,cv_size2= 1, x_lab="Number of training samples", y_var1="coverage",y_var2="total_time",y_lab1="Coverage",y_lab2="Total time (s)")
