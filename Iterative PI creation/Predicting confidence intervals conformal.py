...
training_data_names = [["linear_multi"]]
#noise_types = ["normal","block","student","laplace"]
noise_types = ["normal"]
dataset_names = ["nothing"]
optimisers = ["adam"]
#optimisers = ["adam"]
#bagging_fractions = [0.1,0.3,0.5] # already done "1" with cv=50
bagging_fractions = [1]
num_features_arr = [6]
                                ...
                                for num_features in num_features_arr:
                                    ...
                                    if os.path.exists(out_file_name):
                                        ...
                                        if real_data:
                                            ...
                                            existing_df = pd.DataFrame(columns=["strategy", "data_name", "coverage", "mean_width", "cwc", "mwi","total_time","noise_std","num_samples","noise_type","layer_size","ssc","cv_size", "optimiser", "bagging_fraction", "normalised_mean_width"])
