                ...
                for dataset_name in dataset_names:
                    for cv_size in cv_sizes:
                        ...
                        STRATEGIES = {
                            ...
                            # "jackknife_plus_ab": dict(method="plus", cv=Subsample(n_resamplings=cv_size)),
