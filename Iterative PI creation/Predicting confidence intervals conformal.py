...
#GENERATE DATA
out_file_name = "results_withcv.csv" #REMEBER TO CHANGE THE FILENAME
...
num_samples_array = [1000] #Training data size
cv_sizes = [5,10,20,50]
#cv_sizes = [2]
...
if real_data:
    ...
    #dataset_names = ["yacht_hydro.csv", "boston.csv","hour.csv"]#hour is the bike UCI dataset
    dataset_names = ["boston.csv"]
                    ...
                    for cv_size in cv_sizes:
                        ...
                        #Plot and calculate real data graphs
                            ...
                            for strategy, params in STRATEGIES.items():
                                ...
                                coverage,mean_width, cwc,mwi, y_ci, total_time,ssc = train_and_run_ci(
                                    mlp_regressor,x_train,y_train,x_test,y_test,x_calib,y_calib, alpha, dataset_name,strategy, params, real_data, noise_type, 0,"string"
                                    )
                                results.append({
                                    "datset" : dataset_name,
                                    "strategy": strategy,
