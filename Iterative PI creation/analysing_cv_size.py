...
more_plotting.plot_coverage_for_specific_multi(df, strategy1="cv_plus", data_name1="linear", noise_type1="normal", layer_size1="(200, 1000)", 
                                               num_samples1=1000, noise_std1=1,cv_size1= 50,x_var="cv_size",
                               strategy2="cv_plus", data_name2="linear", noise_type2="normal", layer_size2="(400, 2000, 2000, 2000)", 
                               ...
                               title="Comparing CV+ (200, 1000) and (400, 2000, 2000, 2000) layer size coverage and computation time")
...
more_plotting.plot_coverage_for_specific_multi(df, strategy1="cv_plus", data_name1="linear", noise_type1="normal", layer_size1="(200, 1000)", 
                               ...
                               num_samples2=1000, noise_std2=1,cv_size2= 50, x_lab="Network layer size", y_var1="coverage",y_var2="total_time",y_lab1="Coverage",y_lab2="Total time (s)",
                               title="Comparing CV+ and JK+ab coverage and computation time")

more_plotting.plot_coverage_for_specific_multi(df, strategy1="cv_plus", data_name1="linear", noise_type1="normal", layer_size1="(200, 1000)", 
                                               num_samples1=1000, noise_std1=1,cv_size1= 50,x_var="layer_size",
                               strategy2="jackknife_plus_ab", data_name2="linear", noise_type2="normal", layer_size2="(200, 1000, 1000, 1000)", 
                               num_samples2=1000, noise_std2=1,cv_size2= 50, x_lab="Network layer size", y_var1="cwc",y_var2="mwi",y_lab1="CWC",y_lab2="MWI",
                               title="Comparing CV+ and JK+ab coverage and computation time")
...
"""
STICKING THESE 2 TOGETHER TO MAKE A COMPARISON OF CV+ AND JKPAB - HOW GOOD IS BAGGING?

"""
df_cv_plus = more_plotting.remove_var_df(df, "strategy", "cv_plus")
df_cjkpab = more_plotting.remove_var_df(df, "strategy", "jackknife_plus_ab")
more_plotting.plot_box_for_specific_multi(df1=df_cv_plus,df2=df_cjkpab, data_name1="linear", hue1=None, x_var="layer_size",
                                data_name2="linear", hue2=None,x_lab="Layer size", y_var1="coverage",y_var2="coverage",y_lab1="Coverage", y_lab2="CWC",
                               title=None)
more_plotting.plot_box_for_specific_multi(df1=df_cv_plus,df2=df_cjkpab, data_name1="linear", hue1=None, x_var="layer_size",
                                data_name2="linear", hue2=None,x_lab="Layer size", y_var1="total_time",y_var2="total_time",y_lab1="Total time (s)", y_lab2="Total time (s)",
                               title=None)
...
# df1 = pd.read_csv("all_data_simulated.csv")
    
# df1 = df1[df1["strategy"]=="jackknife_plus_ab"]
# df1 = df1[df1["num_samples"]==1000]
# df1 = df1[df1["data_name"]=="linear"]
# df1.to_csv("justjkp_forbagging.csv", index=True)