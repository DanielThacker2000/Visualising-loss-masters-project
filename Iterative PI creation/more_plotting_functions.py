...
alpha= 0.1
file_name= "iterating_network_params_with_split.csv"
...
plot_coverage_for_specific_multi(df, strategy1="split_resid_norm", data_name1="cube", noise_type1="normal", layer_size1="(200, 1000)", num_samples1=1000, noise_std1=1, x_var="layer_size",
                               strategy2="split_resid_norm", data_name2="cube", noise_type2="student", layer_size2="(200, 1000)", num_samples2=1000, noise_std2=4, x_lab="layer_size")
#%%
...
parameter_list = ["(200, 1000)","(400, 2000)"]
...
plotter.plot_images(function_name="nmm", num_samples_str="1000", noise_type="normal", std="0.5", strategy="split_resid_norm",layer_size="(200, 1000)", iterated_parameter="layer_size",parameter_list=parameter_list)
...
plot_ssc(df, 'split_resid_norm', 'nmm', 0, 1000, 'normal', '(200, 1000)')
plot_ssc(df, 'cqr', 'nmm', 0, 1000, 'normal', '(200, 1000)')
plot_ssc(df, 'jackkife_plus_ab', 'nmm', 0, 1000, 'normal', '(200, 1000)')
