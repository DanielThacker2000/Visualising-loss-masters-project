...
plot_coverage_for_specific_multi(df, strategy1="split_resid_norm", data_name1="sinex_het", noise_type1="normal", layer_size1="(200, 1000)", num_samples1=1000, noise_std1=1, x_var="strategy",
                               strategy2="split_resid_norm", data_name2="sinex_con", noise_type2="normal", layer_size2="(200, 1000)", num_samples2=1000, noise_std2=1, x_lab="strategy")
...
# get_summary(x_var_array,x_var_label_array, filter_function="cube",y_var="coverage", y2_var="mean_width")
get_summary(x_var_array,x_var_label_array, filter_function="linear",y_var="coverage", y2_var="time", y_var_title1="Coverage",y_var_title2="Time (s)")
...
plot_ssc(df, 'split_resid_norm', 'sinex_het', 0, 1000, 'normal', "(400, 2000, 2000, 2000)", "SSC Values for Residual Normal Score and heteroscedastic noise")
plot_ssc(df, 'cqr', 'sinex_het', 0, 1000, 'normal', '(200, 1000)', "SSC Values for CQR and heteroscedastic noise")
plot_ssc(df, 'jackkife_plus_ab', 'sinex_het', 0, 1000, 'normal', '(200, 1000)')
