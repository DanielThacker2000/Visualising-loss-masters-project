...
def plot_coverage_for_specific_multi(df, strategy1, data_name1, noise_type1, layer_size1, num_samples1, noise_std1, x_var,
                               strategy2, data_name2, noise_type2, layer_size2, num_samples2, noise_std2):
    ...
    fig.suptitle(f'Coverage and Mean Width vs {x_var} for {keys1[0]} function, {keys1[2]} layer size, {keys1[3]} sample number, {keys1[4]} noise std. Comparing normal and student noise.',fontsize=16)
    fig.tight_layout()
    plt.show()
...
def plot_box_for_specific_function_and_noise_type(df,x_var, y_var, hue, y2_var, filter_function, x_axis_name,noise_type):
    df = df[df["data_name"] == filter_function]
...
def get_summary(x_var_array,x_var_label_array, filter_function="cube",y_var="coverage", y2_var="mean_width", y_var_title1="Coverage",y_var_title2="Mean Width"):
    ...
    plot_box_for_specific_function_and_noise_type(df,x_var="noise_std", y_var=y_var, hue=None, y2_var=y2_var, filter_function=filter_function, x_axis_name="Noise scaling factor",noise_type="student")
    plot_box_for_specific_function_and_noise_type(df,x_var="noise_std", y_var=y_var, hue=None, y2_var=y2_var, filter_function=filter_function, x_axis_name="Noise scaling factor",noise_type="normal")
...
plot_coverage_for_specific_multi(df, strategy1="jackknife_plus_ab", data_name1="cube", noise_type1="normal", layer_size1="(200, 1000)", num_samples1=1000, noise_std1=1, x_var="strategy",
                               strategy2="jackknife_plus_ab", data_name2="cube", noise_type2="student", layer_size2="(200, 1000)", num_samples2=1000, noise_std2=4)
...
# get_summary(x_var_array,x_var_label_array, filter_function="linear",y_var="coverage", y2_var="cwc", y_var_title1="Coverage",y_var_title2="Coverage-Width Based Criterion")
# get_summary(x_var_array,x_var_label_array, filter_function="cube",y_var="coverage", y2_var="cwc", y_var_title1="Coverage",y_var_title2="Coverage-Width Based Criterion")
