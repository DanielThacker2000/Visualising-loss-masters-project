...
class Plotter:
    ...
    def plot_images_from_dir(self, dir_path,title_list, im_width=12,im_height=4.8,cols=2):
        images = []
        ...
        plt.subplots_adjust(wspace=0, hspace=0.07, left=0, right=1, bottom=0, top=1)
        axes = axes.flatten()  # Flatten the 2D array of axes for easy iteration
