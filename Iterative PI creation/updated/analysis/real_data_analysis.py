...
alpha= 0.1
file_name= "real_results_boston_yacht_hour_concrete_with_norm.csv"
...
plotting_real.plot_coverage_for_specific_multi_real(
    df, 
    strategy1="jackknife_plus_ab", data_name1="boston", noise_type1="normal", layer_size1="(400, 2000, 2000, 2000)", num_samples1=1000, noise_std1=1,cv_size1= 50,
    x_var="strategy",
    strategy2="jackknife_plus_ab", data_name2="hour", noise_type2="normal", layer_size2="(400, 2000, 2000, 2000)", num_samples2=1000, noise_std2=1,cv_size2= 50, 
    x_lab="Strategy", y_var1="coverage",y_var2="normalised_mean_width",y_lab1="Coverage",y_lab2="Normalised Mean width",
    title="Boston data set (506 data points) vs Bike data set (17379 data points)"
    )
#%%
"""
Take summurative box plots
"""

plotting_real.plot_box_for_specific_multi_real(df1=df,df2=df, hue1="strategy", x_var="dataset",
                                 hue2="strategy",x_lab="Strategy", y_var1="coverage",y_var2="mean_width",y_lab1="Coverage", y_lab2="Mean Width",
                               title=None)
